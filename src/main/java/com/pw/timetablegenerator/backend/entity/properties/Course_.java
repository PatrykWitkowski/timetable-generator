...
public class Course_ {
    ...
    public static final String PARITY_ODD = "courses.parity.odd.label";
    public static final String PARITY_WEEKLY = "courses.parity.weekly.label";
    public static final String COURSE = "courses.label";
